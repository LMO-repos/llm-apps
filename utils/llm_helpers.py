...
# NOTE: LLM calls are no longer made from this module.
# They are done directly in the notebooks with LangChain's `init_chat_model`,
# so this file only keeps the data / image / display helpers.
